...
public class DateUtil {
    ...
    public static int lastDayOfMonth(Date monthDate) {
        Calendar calendar = getCalendar(DateUtil.format(DATE_NORMAL_FORMAT, monthDate));
        //获取某月最大天数
    ...
    public static boolean isFirstDayOfMonth(Date monthDate) {
        ...
        String dayStirng = DateUtil.format("dd", monthDate);
    ...
    public static boolean isSameMonth(Date dateOne, Date dateTwo) {
        ...
        return DateUtil.format("MM", dateOne).equals(DateUtil.format("MM", dateTwo));
    }
    ...
    public static List<Date> getDateDiffListWithoutEndTime(Date startTime, Date endTime) {
        List<Date> dateDiffList = DateUtil.getDateDiffList(startTime, endTime);
